...
def get_ukraine_330kv_grid() -> dict:
    ...
    **Topology:**
    ...
    return {
        ...
        "generators": [
                    {"bus": 3,  "p_mw": 900,  "name": "Rivne NPP"},
                    {"bus": 4,  "p_mw": 900,  "name": "Khmelnytskyi NPP"},
                    {"bus": 5,  "p_mw": 1100, "name": "Burshtyn TES"},
                    {"bus": 7,  "p_mw": 500,  "name": "Dniester PSPP"},
                    {"bus": 10, "p_mw": 1300, "name": "Pivdennoukrainska NPP"},
                    {"bus": 13, "p_mw": 3000, "name": "Zaporizhzhia NPP"},
                    {"bus": 15, "p_mw": 1300, "name": "Kryvyi Rih TPP"},
                    {"bus": 16, "p_mw": 200,  "name": "Dnipro HPP"},
        ],
        "loads": [
